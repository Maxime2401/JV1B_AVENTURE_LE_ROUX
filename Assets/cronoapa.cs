...
public class DisparitionReapparition : MonoBehaviour
{
    ...
    IEnumerator DisparaitreEtReapparaitre()
    {
        while (true)
        {
            ...
            rend.enabled = true; 
            yield return new WaitForSeconds(tempsReapparitionbugereffet);
        }
    }
}
